...
def estimate_tokens(text: str) -> int:
    """Token estimation for Claude (approximately 3.5 characters = 1 token)"""
...
def main():
    ...
    with TerminalLogger(terminal_log_file) as logger:
        ...
        print(" CLAUDE 3.5 SONNET SUMMARY-AIDED CONTEXT RETENTION TESTER")
        ...
        # Save final results
        results_file = os.path.join(OUTPUT_DIR, f"summary_results_{timestamp}.json")
